...
public class MultiplayerLobbyMenu : MonoBehaviourPunCallbacks
{
    ...
    public void OnLoginButtonClicked()
    {
        ...
        if (!playerName.Equals(""))
        {
            ...
            applicationData.networkUsers[0].username = playerName;
    ...
    public void OnStartGameButtonClicked()
    {
        ...
        PhotonNetwork.LoadLevel("2_Multiplayer_Game");
    }
